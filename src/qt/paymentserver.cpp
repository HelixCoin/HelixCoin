...
const QString BITCOIN_IPC_PREFIX("helixcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click helixcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start helixcoin: click-to-pay handler");
    else
...
{
    // clicking on helixcoin: URLs creates FileOpen events on the Mac:
